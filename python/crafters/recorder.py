...
class EpisodeRecorder:
    ...
    def _save(self):
        ...
        episode = {key: np.array([step[key] for step in self._episode]) for key in self._episode[0]}
...
class EpisodeName:
    ...
    def step(self, action):
        ...
        if done:
            ...
            self._unlocked = sum(int(value >= 1) for value in info["achievements"].values())
        return obs, reward, done, info
